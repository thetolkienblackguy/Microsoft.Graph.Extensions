...
Function Get-GraphUserAuthenticationMethod {
    <# 
        .DESCRIPTION
        Gets the authentication method for a user or users in Entra Id.

        .SYNOPSIS
        Gets the authentication method for a user or users in Entra Id.

        .PARAMETER UserId
        The user or users to get the authentication method for. This can be a single user or an array of users.
